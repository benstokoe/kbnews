...
import punctuationRegex from "utils/regex/punctuation";
...
const NewCommentForm = ({
  ...
  const { postId, mutateGlobalCount, mutateComments } = useComments();
      ...
      <div className="flex flex-grow flex-col min-h-14">
        <div className="flex-grow flex items-center space-x-2">
          ...
          <label className="flex-grow flex items-center cursor-text select-none focus-within-ring min-h-14">
            ...
            <textarea
              className="block bg-transparent flex-grow leading-5 min-h-5 max-h-36 resize-none m-0 px-0 text-primary border-none overflow-auto text-sm transition-opacity disabled:opacity-50 focus:outline-none focus:shadow-none focus:ring-0"
